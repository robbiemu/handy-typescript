...
Defined in: [src/aop/interrupting-before.decorator.ts:11](https://github.com/robbiemu/handy-typescript/blob/3eaf458/src/aop/interrupting-before.decorator.ts#L11)
