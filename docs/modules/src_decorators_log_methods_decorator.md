...
Defined in: [src/decorators/log-methods.decorator.ts:19](https://github.com/robbiemu/handy-typescript/blob/02d2b30/src/decorators/log-methods.decorator.ts#L19)
