...
Defined in: [src/aop/interrupting-before.decorator.ts:11](https://github.com/robbiemu/handy-typescript/blob/1ebcc03/src/aop/interrupting-before.decorator.ts#L11)
