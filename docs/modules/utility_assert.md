[handy-typescript](../README.md) / [Modules](../modules.md) / utility/assert
...
Defined in: [src/utility/assert.ts:11](https://github.com/robbiemu/handy-typescript/blob/5f4327e/src/utility/assert.ts#L11)
