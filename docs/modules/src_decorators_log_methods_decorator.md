...
Defined in: [src/decorators/log-methods.decorator.ts:19](https://github.com/robbiemu/handy-typescript/blob/87af4f8/src/decorators/log-methods.decorator.ts#L19)
