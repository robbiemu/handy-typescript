...
Defined in: [src/decorators/log-methods.decorator.ts:19](https://github.com/robbiemu/handy-typescript/blob/064cc3a/src/decorators/log-methods.decorator.ts#L19)
