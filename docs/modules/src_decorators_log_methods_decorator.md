...
Defined in: [src/decorators/log-methods.decorator.ts:19](https://github.com/robbiemu/handy-typescript/blob/8d5cf58/src/decorators/log-methods.decorator.ts#L19)
