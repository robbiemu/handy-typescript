...
Defined in: [src/aop/interrupting-before.decorator.ts:10](https://github.com/robbiemu/handy-typescript/blob/8d5cf58/src/aop/interrupting-before.decorator.ts#L10)
