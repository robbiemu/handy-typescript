[handy-typescript](../README.md) / [Modules](../modules.md) / src/utility/assert
...
Defined in: [src/utility/assert.ts:11](https://github.com/robbiemu/handy-typescript/blob/60b7785/src/utility/assert.ts#L11)
