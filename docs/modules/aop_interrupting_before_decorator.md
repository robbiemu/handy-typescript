...
Defined in: [src/aop/interrupting-before.decorator.ts:11](https://github.com/robbiemu/handy-typescript/blob/36c23cf/src/aop/interrupting-before.decorator.ts#L11)
