...
Defined in: [src/decorators/log-methods.decorator.ts:19](https://github.com/robbiemu/handy-typescript/blob/2f4db4b/src/decorators/log-methods.decorator.ts#L19)
