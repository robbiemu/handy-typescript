...
Defined in: [src/aop/interrupting-before.decorator.ts:9](https://github.com/robbiemu/handy-typescript/blob/0fc5e0a/src/aop/interrupting-before.decorator.ts#L9)
